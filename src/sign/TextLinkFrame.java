 ...
 * 
 * @version $Id: TextLinkFrame.java 52 2007-11-08 03:56:17Z martin $
 */
public class TextLinkFrame extends JFrame
{
	...
	{
		south = new JPanel();
		final JButton closeButton = new JButton("Close", new ImageIcon(Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/sCancel.jpg"))));
		final JButton doneButton = new JButton("Done", new ImageIcon(Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/sOK-Done.jpg"))));
