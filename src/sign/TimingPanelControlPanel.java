 ...
 * 
 * @version $Id: TimingPanelControlPanel.java 52 2007-11-08 03:56:17Z martin $
 *
 */
public class TimingPanelControlPanel extends VideoButtonsPanel
{
	...
	private void addButtons()
	{
		final ImageIcon frameBack = new ImageIcon(Toolkit.getDefaultToolkit().getImage(
				this.getClass().getResource("/sHandleStepBackward.jpg")));
		final ImageIcon frameForward = new ImageIcon(Toolkit.getDefaultToolkit().getImage(
				this.getClass().getResource("/sHandleStepForward.jpg")));
		final ImageIcon beginningIcon = new ImageIcon(Toolkit.getDefaultToolkit()
				.getImage(this.getClass().getResource("/sHandleStart.jpg")));
		final ImageIcon endingIcon = new ImageIcon(Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/sHandleEnd.jpg")));
		final ImageIcon previewIcon = new ImageIcon(Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/sPlaySignlink.jpg")));
