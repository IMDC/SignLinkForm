 ...
 * 
 * @version $Id: VideoButtonsPanel.java 52 2007-11-08 03:56:17Z martin $
 */
public class VideoButtonsPanel extends JPanel
{
	...
	private void addIcons()
	{
		...
		rewindIcon = new ImageIcon(Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/sRewind.jpg")));
		...
		fastForwardIcon = new ImageIcon(Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/sFastForward.jpg")));
		...
		frameBackIcon = new ImageIcon(Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/sStepBackward.jpg")));
		...
		frameForwardIcon = new ImageIcon(Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/sStepForward.jpg")));
