...
public class ImageTab extends JPanel
{
	class ButtonsListener implements ActionListener
	{
		...
		public void actionPerformed(final ActionEvent event)
		{
			...
			{
				frame.setPreview(ImageTab.this.getImage(glass.getStartX() - vPanel.getX() - OFFSETX, glass.getStartY() - OFFSETY
						- vPanel.getY(), glass.getViewWidth(), glass.getViewHeight()));
				iComp.setValue(vPanel.getTime());
				iComp.setPosition(vSlide.getCoordfromValue(iComp.getValue()));
				frame.setiFrameTime(vPanel.getTime());
			}
...
//				vSlide.repaint();
	...
	private int								tempGlassX;
	private int								tempGlassY;
	private int								tempGlassWidth;
	private int								tempGlassHeight;
	private int								tempSliderMin;
	private int								tempSliderMax;
	private int								tempSliderCurrent;
	...
	protected ImageIcon getImage(final int x, final int y, final int width, final int height)
	{
		...
		if (glass != null)
		{
			frame.setIFrameX(x);
			frame.setIFrameY(y);
			frame.setIFrameWidth(width);
			frame.setIFrameHeight(height);
		}
		return vPanel.getImage(x, y, width, height);
	}
	...
	{
		glass.setStartX(this.getTempGlassX());
		glass.setEndX(this.getTempGlassX() + this.getTempGlassWidth());
		glass.setStartY(this.getTempGlassY());
		glass.setEndY(this.getTempGlassY() + this.getTempGlassHeight());
		vSlide.setMinimum(this.getTempSliderMin());
		vSlide.setMaximum(this.getTempSliderMax());
		iComp.rollbackChanges();
		vPanel.setTimeMiliseconds(iComp.getValue());
		vSlide.setValue(iComp.getValue());
		vSlide.repaint();
		frame.setPreview(ImageTab.this.getImage(glass.getStartX() - vPanel.getX() - OFFSETX, glass.getStartY() - OFFSETY - vPanel.getY(),
				glass.getViewWidth(), glass.getViewHeight()));
		frame.setiFrameTime(iComp.getValue());
	}
	...
	{
		this.setTempGlassX(glass.getStartX());
		this.setTempGlassY(glass.getStartY());
		this.setTempGlassWidth(glass.getEndX() - glass.getStartX());
		this.setTempGlassHeight(glass.getEndY() - glass.getStartY());
		iComp.commitChanges();
		this.setTempSliderMin(vSlide.getMinimum());
		this.setTempSliderMax(vSlide.getMaximum());
		this.setTempSliderCurrent(iComp.getValue());
	}

	/**
	 * Getter method to return the value of tempGlassX
	 * 
	 * @return the tempGlassX
	 */
	protected int getTempGlassX()
	{
		return this.tempGlassX;
	}

	/**
	 * Setter method to set the value of tempGlassX
	 * 
	 * @param tempGlassX
	 *            the value to set
	 */
	protected void setTempGlassX(int tempGlassX)
	{
		this.tempGlassX = tempGlassX;
	}

	/**
	 * Getter method to return the value of tempGlassY
	 * 
	 * @return the tempGlassY
	 */
	protected int getTempGlassY()
	{
		return this.tempGlassY;
	}

	/**
	 * Setter method to set the value of tempGlassY
	 * 
	 * @param tempGlassY
	 *            the value to set
	 */
	protected void setTempGlassY(int tempGlassY)
	{
		this.tempGlassY = tempGlassY;
	}

	/**
	 * Getter method to return the value of tempGlassWidth
	 * 
	 * @return the tempGlassWidth
	 */
	protected int getTempGlassWidth()
	{
		return this.tempGlassWidth;
	}

	/**
	 * Setter method to set the value of tempGlassWidth
	 * 
	 * @param tempGlassWidth
	 *            the value to set
	 */
	protected void setTempGlassWidth(int tempGlassWidth)
	{
		this.tempGlassWidth = tempGlassWidth;
	}

	/**
	 * Getter method to return the value of tempGlassHeight
	 * 
	 * @return the tempGlassHeight
	 */
	protected int getTempGlassHeight()
	{
		return this.tempGlassHeight;
	}

	/**
	 * Setter method to set the value of tempGlassHeight
	 * 
	 * @param tempGlassHeight
	 *            the value to set
	 */
	protected void setTempGlassHeight(int tempGlassHeight)
	{
		this.tempGlassHeight = tempGlassHeight;
	}

	/**
	 * Getter method to return the value of tempSliderMin
	 * 
	 * @return the tempSliderMin
	 */
	protected int getTempSliderMin()
	{
		return this.tempSliderMin;
	}

	/**
	 * Setter method to set the value of tempSliderMin
	 * 
	 * @param tempSliderMin
	 *            the value to set
	 */
	protected void setTempSliderMin(int tempSliderMin)
	{
		this.tempSliderMin = tempSliderMin;
	}

	/**
	 * Getter method to return the value of
	 * 
	 * @return the tempSliderMax
	 */
	protected int getTempSliderMax()
	{
		return this.tempSliderMax;
	}

	/**
	 * Setter method to set the value of tempSliderMax
	 * 
	 * @param tempSliderMax
	 *            the value to set
	 */
	protected void setTempSliderMax(int tempSliderMax)
	{
		this.tempSliderMax = tempSliderMax;
	}

	/**
	 * Getter method to return the value of tempSliderCurrent
	 * 
	 * @return the tempSliderCurrent
	 */
	protected int getTempSliderCurrent()
	{
		return this.tempSliderCurrent;
	}

	/**
	 * Setter method to set the value of tempSliderCurrent
	 * 
	 * @param tempSliderCurrent
	 *            the value to set
	 */
	protected void setTempSliderCurrent(int tempSliderCurrent)
	{
		this.tempSliderCurrent = tempSliderCurrent;
	}
