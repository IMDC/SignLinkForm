...
public class SignLinkComponent extends JComponent
{
	...
	private class SignLinkPanel extends JPanel
	{
		...
		protected void addSign(final SignLink aSign, final int location, boolean fromXML)
		{
			...
			linkLabel.setText(aSign.getLinkAddress());
		...
		protected void select(final int index)
		{
			...
			final SignLink sign = getSign(selected);
			linkLabel.setText(sign.getLinkAddress());
			final SignSlider slide = frame.getVComponent().getVideoButtonsPanel().getVSlide();
			// and color it red
			// added getCoordfromValue
			slide.setActiveStart(slide.getCoordfromValue(sign.getStartTime()));
			slide.setActiveEnd(slide.getCoordfromValue(sign.getEndTime()));
			frame.getVComponent().getImageLabel().setVisible(true);

		}

		protected void updateLink(final SignLink aSign)
		{
	...
	public SignLinkComponent(final MenuFrame mFrame)
	{
		...
		signList = new ArrayList<SignLink>();
		frame = mFrame;
	...
	public SignLinkComponent(final MenuFrame mFrame, final ArrayList<SignLink> signs)
	{
		sPanel = new SignLinkPanel();
		sButtonsPanel = new SignButtonsPanel(mFrame);
		signList = signs;
	 ...
	 *            the signLink to add
	 */
	public void addSign(final SignLink sign)
	{
	 ...
	 * @return Signlink
	 */
	public SignLink getSign(final int index)
	{
	 ...
	 * @return the signList
	 */
	public ArrayList<SignLink> getSignList()
	{
		return signList;
	}
	 ...
	 *            the signList to set
	 */
	public void setSignList(final ArrayList<SignLink> signList)
	{
		this.signList = signList;
	}

	public void updateSign(final SignLink sign)
	{
